...
class CockroachOrderRepository(connection: Connection)  extends AOrderRepository {
  ...
  val qTruncate: String = "USE octo; TRUNCATE orders CASCADE;"
  ...
  override def insert(orderID: String,customerID: String): Int = {
    ...
    preparedInsertOrder.setString(1, orderID)
    preparedInsertOrder.setString(2, customerID)
  ...
  override def validationOrder(orderID: String): Int = {
    ...
    preparedValidationOrder.setString(1, orderID)
